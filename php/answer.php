...
$url = $_GET['url'];  // uploaded/***.php
echo "<iframe src='".$url.".php' width='1485' height='600'></iframe><br><br>";
$_SESSION['iframe_path'] = $url;
var_dump($url);
$replace1 = ltrim($url, 'uploaded/'); //クエリパラメータ
var_dump($replace1);

$_SESSION['answer_count'] = $_SESSION['answer_count'] + 1;
if($_SESSION['answer_count'] == 1){
  $_SESSION['random_answer'] = date('Ymd-His-') . rand(10000, 99999);
  $initial_path = dirname(__FILE__) . '/answer_uploaded/' . $replace1 . $_SESSION['random_answer'] . '.php';
  touch($initial_path);
}

$_SESSION['query'] = $replace1;

$file = "answer_uploaded/" . $replace1 . $_SESSION['random_answer'] . ".php";
$_SESSION['insert_script'] = $file;
...
<body onload="changeColor();">
  <h3>回答作成画面</h3><br><br>
  <iframe id="hoge" src="http://localhost/Web/php/answer_uploaded/<?=$_SESSION['random_answer']?>.php" width="1485" height="600"></iframe><br><br>
  ...
  <form action="consv_answer.php" method="post">
